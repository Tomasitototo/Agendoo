        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch max-w-4xl mx-auto">
          ...
          <AnimatedCard index={0} className="max-w-md w-full mx-auto bg-white/10 border border-white/20 backdrop-blur-sm rounded-3xl p-8 text-white flex flex-col h-full">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full py-3 rounded-2xl font-semibold bg-white/15 border border-white/30 text-white hover:bg-white/25 transition-all duration-200 mt-auto">
              Comenzar ahora
            </motion.button>
          </AnimatedCard>
          ...
          <AnimatedCard index={1} className="relative max-w-md w-full mx-auto bg-white rounded-3xl p-8 text-gray-900 shadow-[0_25px_60px_rgba(0,0,0,0.25)] flex flex-col h-full">
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.95 }}
              className="w-full py-3 rounded-2xl font-semibold bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 mt-auto">
              Comenzar ahora
            </motion.button>
          </AnimatedCard>
        ...
        <AnimatedCard index={0} className="relative overflow-hidden rounded-3xl p-16 lg:p-20 text-center" style={{ background: "linear-gradient(135deg, #1B72F0 0%, #0d5fd4 100%)" }}>
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center flex-wrap">
              <motion.a
                href="https://wa.me/TUNUMERO?text=Hola!%20Quiero%20empezar%20a%20reservar%20mis%20turnos%20online%20con%20Agendoo"
                target="_blank"
        ...
        <div className="flex flex-col md:flex-row justify-between items-start px-12 pb-12 border-b border-white/10 z-10 w-full max-w-7xl mx-auto">
          ...
          <div className="mb-10 md:mb-0">
            ...
            <div className="mt-6 flex gap-4">
              <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/20 transition-all">
              ...
              <a href="#" aria-label="WhatsApp" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/20 transition-all">
