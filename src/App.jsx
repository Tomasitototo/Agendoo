...
const PricingSection = () => {
  ...
  return (
    <section id="precios" className="bg-[#1B72F0] py-24">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-white/10 rounded-full p-1 inline-flex gap-1 items-center">
            <button
              onClick={() => setIsAnnual(false)}
              className={`rounded-full px-5 py-2 text-sm font-semibold cursor-pointer transition-all duration-200 ${
                !isAnnual ? "bg-white text-blue-700" : "text-white/70 hover:text-white"
              }`}
            >
              Mensual
            </button>
            <button
              ...
              className={`rounded-full px-5 py-2 text-sm font-semibold cursor-pointer transition-all duration-200 flex items-center ${
                isAnnual ? "bg-white text-blue-700" : "text-white/70 hover:text-white"
              }`}
            >
              Anual
              <span className="bg-green-400 text-green-900 text-xs font-bold rounded-full px-2 py-0.5 ml-1">
                Ahorrá 15%
              </span>
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          {/* CARD BÁSICO */}
          <div className="bg-white/10 border border-white/20 backdrop-blur-sm rounded-3xl p-8 text-white flex flex-col h-full">
            ...
            <div className="text-5xl font-extrabold text-white">
              ${isAnnual ? "34" : "40"} <span className="text-2xl font-normal text-white/60">/mes</span>
            </div>
            ...
            <button className="w-full py-3 rounded-2xl font-semibold bg-white/15 border border-white/30 text-white hover:bg-white/25 transition-all duration-200 mt-auto">
              Consultar
            </button>
          </div>

          {/* CARD PREMIUM */}
          <div className="bg-white rounded-3xl p-8 text-gray-900 shadow-[0_25px_60px_rgba(0,0,0,0.25)] flex flex-col h-full">
            ...
            <div className="text-5xl font-extrabold text-gray-900">
              ${isAnnual ? "60" : "70"} <span className="text-2xl font-normal text-gray-400">/mes</span>
            </div>
            ...
            <button className="w-full py-3 rounded-2xl font-semibold bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 mt-auto">
              Quiero el Premium
            </button>
          </div>
        ...
        <div className="mt-8 bg-white/10 border border-white/20 rounded-2xl p-6 text-center backdrop-blur-sm">
          ...
          <p className="text-white/70 text-sm">
            Si nuestro sistema no mejora la gestión de tu agenda, te devolvemos tu dinero.
          </p>
        </div>
