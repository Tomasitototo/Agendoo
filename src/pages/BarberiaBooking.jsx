            ...
            >
              ...
              {authTab === 'login' ? (
                <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <button className="w-full bg-yellow-700 hover:bg-yellow-600 text-white font-bold py-4 rounded-2xl mt-8 shadow-lg shadow-yellow-900/20 transition-all font-['DM_Sans']">
                    Iniciar sesión
                  </button>
                </motion.div>
              ) : (
