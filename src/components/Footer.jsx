      ...
      <div className="flex flex-col md:flex-row justify-between items-start px-12 pb-12 border-b border-white/10 z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-0">
          ...
          <div className="mt-6 flex gap-4">
            <a href="https://www.instagram.com/agendoo.ok/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/20 transition-all">
